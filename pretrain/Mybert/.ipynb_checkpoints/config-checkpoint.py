...
class Config(object):
    def __init__(self):
        ...
        self.output_dir = self.source_data_path + "model-chinese-roberta-wwm-ext/"
        ...
        # self.pretrain_model_path = '../../pretrain_models/chinese-roberta-wwm-ext/'
        # self.pretrain_model_path = '../../pretrain_models/nezha-cn-base/'
        # self.pretrain_model_path = '../../pretrain_models/albert-tiny-chinese/'
        self.pretrain_model_path = '../../pretrain_models/chinese-roberta-wwm-ext/'

        # self.bert_config_json = self.pretrain_model_path + "bert_config.json"  # 为''时从零训练
        # self.bert_config_json = self.pretrain_model_path + "" 
