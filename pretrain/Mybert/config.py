...
class Config(object):
    def __init__(self):
        # -----------ARGS---------------------
        # 原始数据路径
        # self.source_data_path = '/home/wangzhili/data/ccf_emotion/'
        self.source_data_path = '../../data/pretrain/ccf_emotion/'
        # 预训练数据路径
        # self.pretrain_train_path = "/home/wangzhili/data/ccf_emotion/256_corpus.txt"
        self.pretrain_train_path = "../../data/pretrain/ccf_emotion/256_corpus.txt"
        # 模型保存路径
        # self.output_dir = self.source_data_path + "outputs/"
        # self.output_dir = self.source_data_path + "model-albert-tiny-chinese/"
        self.output_dir = self.source_data_path + "model-nezha-cn-base/"
        ...
        # self.pretrain_model_path = '/home/wangzhili/pretrained_model/Torch_model/pre_model_nezha_base/' # 为''时从零训练
        self.pretrain_model_path = '../../../autodl-tmp/pretrain_models/nezha-cn-base/'
        # self.pretrain_model_path = '../../../autodl-tmp/pretrain_models/albert-tiny-chinese/'
        # self.pretrain_model_path = '../../../autodl-tmp/pretrain_models/chinese-roberta-wwm-ext/'

        # self.bert_config_json = self.pretrain_model_path + "bert_config.json"  # 为''时从零训练
        self.bert_config_json = self.pretrain_model_path + "config.json"  

        self.vocab_file = self.pretrain_model_path + "vocab.txt"
        # self.vocab_file = self.pretrain_model_path + ""
